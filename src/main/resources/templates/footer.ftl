            ...
            <div class="col-lg-8 offset-lg-2 col-md-10 offset-md-1">
                <ul class="list-inline text-center">
                    <li class="list-inline-item">
                        <a href="mailto:cxh1960497367@163.com">
                    ...
                    <li class="list-inline-item">
                        <a href="https://www.facebook.com/profile.php?id=100023132013200">
                                <span class="fa-stack fa-lg">
                                    <i class="fa fa-circle fa-stack-2x"></i>
                    ...
                    <li class="list-inline-item">
                        <a href="https://github.com/196049736796">
                                <span class="fa-stack fa-lg">
                                    <i class="fa fa-circle fa-stack-2x"></i>
                ...
                <p class="copyright text-muted">Copyright &copy; 星尘
                    <a href="http://www.miitbeian.gov.cn/">粤ICP备17139781号</a>
                </p>
            </div>
        </div>
    </div>
