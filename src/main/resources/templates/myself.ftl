            ...
            <div class="am-tabs" data-am-tabs>
                ...
                <div class="am-tabs-bd am-tabs-bd-ofv">
                    <div class="am-tab-panel am-active" id="tab-4-1">
                        <form class="am-form am-form-horizontal" id="uUpdateForm">
                        ...
                        <#if loginU.state??>
                            ...
                            <div style="margin-top: 20px;margin-left: 15px">
                                <button type="button" class="am-btn am-btn-primary am-radius" onclick="saveU()">保存
                                </button>
                                <button type="button" onclick="resetForm('uUpdateForm')"
                    ...
                    <#else >
                        ...
                        <div style="text-align: left;margin-top: 20px"><label>第三方账号无法在此更改头像</label></div>
                    </#if>
                    </div>

                <#if loginU.isxing??>
                    <div class="am-tab-panel" id="tab-4-3">
                        <form class="am-form am-form-horizontal" id="changePForm">
                            <div class="am-form-group am-form-feedback">
                                ...
                                <div class="am-u-md-10 am-u-sm-8">
                                    <input type="password" id="opwd" class="am-form-field" name="opwd"
                                           placeholder="输入原来密码" minlength="8" required>
                                </div>
                            </div>
                            <hr>
                            <div class="am-form-group am-form-feedback">
                            ...
                            <hr>
                            <div style="margin-top: 20px;margin-left: 15px">
                                <button type="button" class="am-btn am-btn-primary am-radius" onclick="changeP()">保存
                                </button>
                                <button type="button" onclick="resetForm('changePForm')"
                                        class="am-btn am-btn-default am-radius" style="margin-left: 10px">
                                    取消
                                </button>
                            </div>
                        </form>
...
<div class="am-modal am-modal-alert" tabindex="-1" id="up-modal-alert">
    <div class="am-modal-dialog">
        ...
        <div class="am-modal-footer">
            <span id="btnUpdate" class="am-modal-btn">确定</span>
        </div>
    </div>
</div>
